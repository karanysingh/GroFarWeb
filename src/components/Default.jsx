...
export default function Default() {
  ...
  let picks = [
      {discount:'10%',image:"img/listing/v1.jpg",title:'Chilli',price:'0.8/kg'},
      {discount:'5%',image:"img/listing/v2.jpg",title:'Onion',price:'1.8/kg'},
      {discount:'8%',image:"img/listing/v3.jpg",title:'Cauliflower',price:'1.8/kg'},
      {discount:'12%',image:"img/listing/v4.jpg",title:'Carrot',price:'0.8/kg'},
      {discount:'3%',image:"img/listing/v5.jpg",title:'Tomato',price:'1/kg'},
      {discount:'20%',image:"img/listing/v6.jpg",title:'Cabbage',price:'1/kg'},
      {discount:'50%',image:"img/listing/v7.jpg",title:'Chilli',price:'1.8/kg'},
      {discount:'10%',image:"img/listing/v7.jpg",title:'Onion',price:'1.8/kg'},
  ]
  return (
